...
export const TOOLS_BUILD_WITH = {
  aiDevelopment: ["Cursor", "Claude", "Claude Code", "ChatGPT", "Gemini", "Perplexity", "promptfoo", "MCP", "Google Antigravity"],
  productAndData: ["React", "React Native", "TypeScript", "Python", "Node.js", "Expo", "APIs", "JIRA", "Notion", "Figma"],
  platforms: ["Salesforce", "Oracle", "Intercom", "Google Analytics", "App Store", "Google Play", "Chrome Web Store", "GitHub", "Vercel", "RevenueCat", "Substack"],
};
