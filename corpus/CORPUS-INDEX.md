...
This index maps every corpus file, its content status, and what it's best used for.
Status: COMPLETE = interview-depth narrative, ready for AI use
        PARTIAL = has some content but gaps remain
        PLACEHOLDER = scaffold only, needs interview
...
| rocket-mortgage.md | COMPLETE | 7-year arc from BA to PO, Spanish leads, speech analytics, Salesforce migration | 300% Spanish-preferred leads increase, 50-person bilingual team in 8 months, 1% to 10,000 daily call hours speech analytics, 400 team members / 20 apps Salesforce migration |
| accenture.md | COMPLETE | Consulting foundation, global scheduling platform, Excel automation | 250K+ employee Fortune 500 client, 15-person India call center, 15-workstream SAP automation saving 1,000+ hours |

## 02-thought-leadership

| File | Status | What It Covers | Key Stories/Metrics |
|---|---|---|---|
| key-themes.md | COMPLETE | 6 recurring themes with stories, quotes, and newsletter links | Feature diet, anti-patterns, non-developer building, AI for efficiency, messy PM reality, career development |
| newsletter-archive/README.md | PLACEHOLDER | Instructions for adding top newsletter posts | Needs Mike to identify top 10-15 posts to include |
| quotable-takes.md | COMPLETE | Sharp opinions organized by topic | AI, PM reality, career, prioritization, stakeholder management, building, technical skills |
...
| product-principles.md | COMPLETE | 7 core product beliefs with supporting stories | Singles philosophy, path-not-product, complaints-as-data, 70% rule, field visits |
| quotable-takes.md | COMPLETE | Sharp memorable quotes organized by theme | Building with AI, product work, adaptability, shipping, engineers, career, focus |
| shipping-philosophy.md | COMPLETE | How to get things out the door | Ship-and-see, fail-and-iterate, 20 engineers/2 teams agile, consistency compounds |
| stakeholder-management.md | COMPLETE | Trust-building and conflict resolution | Invest before you need, understand "why", facts over opinions, facilitate consensus |
...
| File | Status | What It Covers | Key Stories/Metrics |
|---|---|---|---|
| sample-exchanges.md | COMPLETE | 8 calibration exchanges showing AI voice | AI replacing PMs, stakeholder handling, experience overview, Leafed story, biggest failure, technical depth, new industries |
| topics-to-avoid.md | COMPLETE | 8 guardrails for the AI assistant | No salary, no negative employer talk, no confidential details, always transparent about being AI |
| voice-guide.md | COMPLETE | Full voice definition with banned phrases and sentence rhythm | Colleague-not-blogger tone, full banned phrases list (authority signaling, AI tells), sentence rhythm rules, response length guidelines |

---

## Files That Still Need Work

- **newsletter-archive/README.md** (PLACEHOLDER): Needs Mike to identify top 10-15 newsletter posts worth including as full markdown files
- **aichatanchor/overview.md** (PARTIAL): Missing key metrics - Chrome Web Store installs, GitHub stars, notable feedback
- **claude-skills/overview.md** (PARTIAL): Only documents Product Party content skill; needs other Claude skills listed [TO BE FILLED]
- **other-projects/README.md** (PARTIAL): Missing interview answers about which projects to highlight to employers vs. keep as learning projects
- **hvac/overview.md** (PARTIAL): Has download count but missing conversion rate (free to pro) and user feedback
...
- Fixed Leafed described as "plant care app" to book tracker in ai-in-product-management.md
- Fixed HVAC Savings Calculator to HVAC Load Calculator
- Removed Meow Game reference (not in shipped apps)
- Fixed speech analytics failure story attribution (Rocket Mortgage, not Auto Approve)
- Removed fabricated $2.5M efficiency gains claim
- Fixed Accenture workstreams to 15 (was 16)
- Added full banned phrases list to voice-guide.md
