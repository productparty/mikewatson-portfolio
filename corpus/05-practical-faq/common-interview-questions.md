...
My ability to see the bigger picture. I connect all the dots via systems thinking. I think that helps me empathize with users at each stage of the journey and know which levers to pull where.

## 4. What's your biggest weakness?

I can get hyper-focused on certain problems and need to remind myself to come back up for air. When I'm deep in solving something, I sometimes need to step back and make sure I'm not over-indexing on one area at the expense of the broader picture.

## 5. Tell me about a product you shipped that failed
...
I use the **70% Rule**: decisions should be made with about 70% of the information you ideally want, not waiting for perfection.

My approach:
- **Customer-first, technology-second**: Technology serves as a tool to enhance the customer experience, not the other way around.
...
I used to think that saying yes to every request was how you proved you belonged at the table as a PM. All that heroic effort was actually making me look incompetent.
...
3. **"If we prioritize this, what should we stop working on?"** This is where the magic happens. Instead of pretending you can just work harder, you make trade-offs explicit. When people hear the actual cost, they often realize it's not as critical.

## 8. How do you measure success?

I start with a question: "What outcome would prove we're succeeding?" Then I work backward to the metrics.

**My measurement framework:**
- **One North Star metric** that represents long-term value
- **Two leading indicators** that predict the North Star
